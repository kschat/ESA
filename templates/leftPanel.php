	...
	<div id="main-left-container">
		<?php 
			if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']) {
				...
				$loginView = new Template('loginView.php', array('loginError' => LOGIN_ERROR));
				$loginView->render();
			}
		?>
		...
		<div id="leftNavContainer">
			<?php
				...
				$sideNavigation = new Template('navigationView.php', array('nodes' => array()));
				...
				foreach($dbh->getTableViewLinks(REQUESTED_PAGE) as $node) {
					...
					if(strcasecmp(REQUESTED_FILTER, $node['url']) == 0) {
						...
						$sideNavigation->nodes = 
							new Template('navigationNodeView.php', array(
